	...
	constructor() {
		super(meta, paramDef, async (ps) => {
			...
			return {
				read: dummy,
				readWrite: dummy,
				registeredOutsideMonth: dummy,
				registeredOutsideWeek: dummy,
				registeredOutsideYear: dummy,
				registeredWithinMonth: dummy,
				registeredWithinWeek: dummy,
				registeredWithinYear: dummy,
				write: dummy,
			};
		});
	}
