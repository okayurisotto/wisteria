...
<section v-if="!hasChildSection" v-panel style="border-radius: var(--rounded); border-bottom: 0.5px solid var(--divider);">
...
<section v-else v-panel style="border-radius: var(--rounded); border-bottom: 0.5px solid var(--divider);">
	<header class="_acrylic" @click="shown = !shown">
...
import { type CustomEmojiFolderTree, getEmojiName } from '@/scripts/emojilist.js';
