	...
	<MkSpacer :marginMin="20" :marginMax="28">
		<div class="_gaps_m">
			...
			<MkFolder :defaultOpen="true">
				...
				<MkSwitch :modelValue="agreeNote" style="margin-top: 16px;" @update:modelValue="updateAgreeNote">{{ i18n.ts.agree }}</MkSwitch>
			</MkFolder>
			...
			<div class="_buttonsCenter">
				...
				<MkButton inline primary rounded gradate :disabled="!agreed" @click="emit('done')">{{ i18n.ts.continue }} <i class="ti ti-arrow-right"></i></MkButton>
			</div>
		</div>
	</MkSpacer>
</div>
