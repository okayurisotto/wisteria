...
import { type VNode, h, type SetupContext } from 'vue';
			...
			case 'fn': {
				...
				switch (token.props.name) {
					...
					case 'unixtime': {
						...
						return h('span', {
							style: 'display: inline-block; font-size: 90%; border: solid 1px var(--divider); border-radius: var(--rounded-full); padding: 4px 10px 4px 6px;',
						}, [
							h('i', {
								class: 'ti ti-clock',
