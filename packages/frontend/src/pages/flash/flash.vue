...
import { computed, onDeactivated, onUnmounted, type Ref, ref, watch, shallowRef } from 'vue';
...
import { type AsUiComponent, type AsUiRoot, registerAsUiLib } from '@/scripts/aiscript/ui.js';
