...
export interface components {
  schemas: {
    ...
    ReversiGameDetailed: {
      ...
      user1Ready: boolean;
      user2Ready: boolean;
      user1Id: components["schemas"]["Id"];
      user2Id: components["schemas"]["Id"];
      user1: components["schemas"]["UserLite"];
      user2: components["schemas"]["UserLite"];
      winnerId: components["schemas"]["Id"];
      winner: components["schemas"]["UserLite"];
      surrenderedUserId: components["schemas"]["Id"];
      timeoutUserId: components["schemas"]["Id"];
      black: number | null;
      bw: string;
...
export interface operations {
  ...
  "i/read-announcement": {
    requestBody: {
      content: {
        "application/json": {
          announcementId: components["schemas"]["Id"];
          [key: string]: unknown;
        };
      };
    };
    ...
    requestBody: {
      content: {
        "application/json": {
          ...
          script: string;
          eyeCatchingImageId?: components["schemas"]["Id"];
          /**
           * @default sans-serif
           * @enum {string}
           */
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            desynced?: boolean;
            game?: components["schemas"]["ReversiGameDetailed"];
            [key: string]: unknown;
          };
        };
      };
